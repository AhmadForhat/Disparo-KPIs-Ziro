        ...
        html: 
            ...
            <tr>
                <td align="center" valign="top">
                    <table border="1" cellpadding="0" cellspacing="0" width="600" id="emailContainer">
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailBody">
                                    <tr>
                                        <td align="center" valign="top">
                                            ...
                                            <table width="100%">
                                                <h4 style="padding: 20px 0; background: #222; color: #fff; text-transform: uppercase"><span style="color: #FFDD00; font-size: 20px">.&nbsp;</span>Comparativo Janeiro 2020 - 2019<span style="color: #FFDD00; font-size: 20px">&nbsp;.</span></h4>
                                                <tbody>
                                                    <tr>
                                                        <td align="end" valign="top" style="padding-right: 20px"><b>Vendido 2020</b></td>
                                                        <td align="start" valign="top" style="padding-left: 20px" width="50%">${data.values[number][2]}</td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <table width="100%">
                                                <h4 style="padding: 20px 0; background: #222; color: #fff; text-transform: uppercase"><span style="color: #FFDD00; font-size: 20px">.&nbsp;</span>Resultados acumulados<span style="color: #FFDD00; font-size: 20px">&nbsp;.</span></h4>
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="center" valign="top" style="border-bottom: 1px dotted rgba(0,0,0,0.1)">${dataMes.values[0][3]}</td>
                                            ...
                                            <table width="100%">
                                                <h4 style="padding: 20px 0; background: #222; color: #fff; text-transform: uppercase"><span style="color: #FFDD00; font-size: 20px">.&nbsp;</span>Resultados do dia<span style="color: #FFDD00; font-size: 20px">&nbsp;.</span></h4>
                                                <thead>
                                                    <tr>
                                                        <th align="center" valign="top">Assessor</th>
                                                        <th align="center" valign="top">Vendido</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="center" valign="top" style="border-bottom: 1px dotted rgba(0,0,0,0.1)">${dataDia.values[0][3]}</td>
